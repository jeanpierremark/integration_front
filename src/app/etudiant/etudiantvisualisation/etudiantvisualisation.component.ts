...
@Component({
  selector: 'app-etudiantvisualisation',
  templateUrl: './etudiantvisualisation.component.html',
  styleUrls: ['./etudiantvisualisation.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EtudiantvisualisationComponent implements OnInit, OnDestroy {
